      ...
      <div className="container">
        ...
        {loading ? (
          ...
          <div className="empty-state">
            <p>No flight data available yet. Log some flights to see your trends!</p>
          ...
          <div className="trends-content">
            <div className="stats-overview">
              ...
              <div className="stat-card">
                ...
                <div className="stat-value" style={{ color: getAnxietyColor(parseFloat(stats.averageAnxiety)) }}>
            ...
            <div className="chart-section">
              ...
              <div className="turbulence-chart">
                {Object.entries(stats.turbulenceDistribution).map(([level, count]) => {
                  ...
                  return (
                    <div key={level} className="turbulence-bar-container">
                      <div className="turbulence-label">
                        <span className="turbulence-level">{level}</span>
                        <span className="turbulence-count">({count} flights)</span>
                      </div>
                      ...
                      <span className="turbulence-percentage">{percentage.toFixed(0)}%</span>
                    </div>
                  );
                })}
              </div>
                    ...
                    <div className="timeline-bar-container">
                      <div 
                        ...
                        style={{ 
                          ...
                          backgroundColor: getAnxietyColor(entry.anxiety)
                        }}
                      >
                        <span className="timeline-value">{entry.anxiety}</span>
                      </div>
                    </div>
                    <div className="timeline-turbulence">{entry.turbulence}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="insights-section">
              ...
              <div className="insight-cards">
                {parseFloat(stats.averageAnxiety) <= 5 && (
                  <div className="insight-card positive">
                    <p>Your average anxiety level is relatively low! Keep tracking your flights to maintain awareness.</p>
                  </div>
                )}
                {stats.turbulenceDistribution.none > stats.totalFlights / 2 && (
                  <div className="insight-card positive">
                    <p>More than half of your flights had no turbulence. Most flights are smooth!</p>
                  </div>
                )}
                {stats.totalFlights >= 5 && (
                  <div className="insight-card">
                    <p>You've logged {stats.totalFlights} flights. Regular flying can help reduce anxiety over time.</p>
                  </div>
                )}
                {stats.totalFlights < 5 && (
                  <div className="insight-card">
                    <p>Keep logging flights to see meaningful trends in your anxiety patterns.</p>
                  </div>
                )}
              </div>
            </div>
